	...
	<view class="orderlist">
		...
		<view class="ol_top">
			<view class="ol_top_mai">
				<view class="ol_topmai_left">
					<view class="ol_topm_top">{{goods.mai}}</view>
					<!-- <view class="ol_topm_time" v-if="goods.status==101">还剩{{contentTime}}自动取消</view> -->
				</view>
		...
		<view class="ol_goods">
			...
			<view class="ol_goods_count">
				...
				<view class="ol_goodsc_gray">
					<text>店铺优惠</text><text  class="right">￥{{goodscount.cut}}</text>
				</view> -->
			...
			<view class="ol_goods_pay">
				<view class="ol_goodsp_top">
					<text class="right">实际价格以门店价格为准</text>
				</view>
				<view class="ol_goods_paytrue">
					<text>应付款</text>
					<text class="right red">￥{{goodscount.countgoods}}</text>
				    <view class="ol_goodsc_gray">
		...
		<view class="ol_goods_infos">
			...
			<view class="ol_goods_orderinfo">
				...
				<view class="info_li" >
					<text>预约时间：</text>
					<text>{{goods.yuyueTime}}</text>
				</view>
				<view class="info_li" v-if="goods.status==201">
					<text>完成时间：</text>
		...
		<view class="ol_bottom">
			...
			<view class="ol_bottom_ok" v-if="goods.status==101" @click="cancelOrder()">
				取消订单
			</view>
