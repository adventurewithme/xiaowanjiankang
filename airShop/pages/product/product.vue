...
<!-- 		<view class="c-row">
		...
		<view class="page-bottom" v-if="footflag">
			...
			<view class="action-btn-group">
				<button type="primary" 
				v-if="product.returnType!='秒杀商品'&&product.returnType!='团购商品'&&product.ifXuni!='true'&&product.returnIfOnlyUserBonus==false" 
		...
		<view class="popup spec" :class="specClass"  @click="toggleSpec">
			...
			<view class="layer attr-content" @click.stop="stopPrevent">
				...
				<view class="attr-list flex_between">
					...
					<view class="add_dis">
						<view v-if="product.returnType!='团购商品' && ( product.returnType=='正常商品' || (product.returnType!='正常商品'&&product.returnAllowBuyGoods==false))" class="dis"><image :src="num_icon_dis" mode="" class="disimg" @click="disgood_num"></image></view>
						<input type="number" value="" v-model="goods_num" class="goods_input" />
						<view v-if="product.returnType!='团购商品' && (product.returnType=='正常商品' || (product.returnType!='正常商品'&&product.returnAllowBuyGoods==false))" class="add"><image :src="num_icon_add" mode=""  class="addimg" @click="addgood_num"></image></view>
					</view>
				</view>
